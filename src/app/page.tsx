          ...
          <div className="pt-[90px] lg:pt-[170px] hidden sm:flex flex-col gap-6">
            ...
            <div className="flex gap-10 items-center">
              <Link
                ...
                className="text-from-20 max-w-[140px] md:max-w-[180px] w-full h-[40px] md:h-[60px] px-2 flex items-center justify-center bg-app-yellow rounded-[85px]"
              >
                Позвонить
              </Link>
              ...
              <Link
                href="tel:+79994444449"
                className="text-from-20 max-w-[140px] md:max-w-[180px] w-full h-[40px] md:h-[60px] px-2 whitespace-nowrap flex items-center justify-center bg-transparent border-2 border-app-yellow rounded-[85px]"
              >
                Оставить номер
              </Link>
            </div>
        ...
        <section className="bg-[#0F2545] rounded-b-[30px] pb-[80px]">
          <Container>
            <div className="flex items-center justify-between py-5 md:py-[50px] lg:py-[80px] font-sans">
              <h3 className="text-[28px] md:text-4xl lg:text-6xl">Квартиры</h3>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                >
                  <p className="text-[16px] md:text-[25px] lg:text-[32px] media-1400:min-w-[800px]">
                    ...
                    света. Здесь вы обретете не просто метры, а пространство для
                    гармонии, уюта и создания семейных традиций.
                  </p>
                </MotionComponent>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <MotionComponent direction="right">
                  <p className="text-[16px] md:text-[25px] lg:text-[32px] max-w-[660px]">
                    ...
                    море и историческую крепость. Идеальное место для вечернего
                    отдыха, принятия солнечных ванн и наслаждения
