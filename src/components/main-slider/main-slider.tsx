...
export default function MainSlider({}) {
  return (
    <Container width={1460} className="relative">
      ...
      <div className="custom-swiper-button-prev absolute top-1/2 left-0 z-100 size-[80px] rounded-[50%] bg-background border-1 border-[#D4AF37] hover:bg-[#D4AF37] duration-150 cursor-pointer">
        <svg
          width="80"
          height="80"
          viewBox="0 0 80 80"
      ...
      <div className="custom-swiper-button-next absolute top-1/2 right-0 size-[80px] rounded-[50%] bg-background border-1 border-[#D4AF37] hover:bg-[#D4AF37] duration-150 cursor-pointer">
        <svg
          width="80"
          height="80"
          viewBox="0 0 80 80"
