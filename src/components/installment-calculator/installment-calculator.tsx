        ...
        <div className="flex justify-between mt-[60px]">
          ...
          <div className="flex flex-col items-center max-w-[600px] max-h-[412px] w-fit h-full pt-[40px] px-[72px] pb-[16] border-1 border-[#162A4D] rounded-[20px]">
            ...
            <div className="flex justify-between mt-[20px] w-full">
              <p className="text-[28px]">Ставка</p>

              <div className=" flex items-center gap-1">
                <span className="text-[30px] font-medium">{bet}</span>
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 25 25"
            ...
            <div className="flex justify-between mt-[20px] w-full">
              <p className="text-[28px]">Платеж в месяц</p>

              <span className="text-[30px] font-medium">{"123123"} руб.</span>
            </div>

            <button className="bg-background max-w-[420px] w-full h-[50px] px-2 mt-[60px] cursor-pointer flex items-center justify-center text-white text-[20px] rounded-[12px] hover:bg-[#d4af37] duration-200">
              Получить консультацию
            </button>
            <span className="text-center mt-[16px] text-[16px] max-w-[362px] leading-[100%]">
